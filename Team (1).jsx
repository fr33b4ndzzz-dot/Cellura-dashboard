...
function ChatModal({ agent, onClose, onOpenTasks }) {
  ...
  async function send() {
    ...
    try {
      ...
      setMessages([...updated, { role: "assistant", content: `⚠️ ${e.message || "Network error — please try again."}` }]);
    }
    setLoading(false);
  }
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 20, display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        {loading && (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
            ...
            <div style={{ background: "#1a1d24", border: "1px solid #242830", borderRadius: "12px 12px 12px 4px", padding: "8px 14px" }}>
